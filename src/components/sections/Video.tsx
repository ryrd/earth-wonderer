  ...
  return (
    <div className='portrait:mt-6 landscape:mt-0'>
      ...
      <div className='relative portrait:h-[20vh] landscape:h-[80vh] flex justify-center items-center portrait:mt-7 landscape:mt-2 md:mb-6 pt-24 sm:pt-0 pb-32 md:pb-3'>
        ...
        <div className='relative w-[80vw] sm:w-[60vw] aspect-video z-10'>
          <Youtube link={video}/>
          <span className='font-oswald font-light text-[6px] dark:text-white md:text-base leading-none absolute -bottom-[10%] md:-bottom-[7%] right-[1%]'>video by <span className='font-bold text-[8px] md:text-xl leading-none'>{videoOwner}</span></span>
        </div>
      </div>
    </div>
  )
