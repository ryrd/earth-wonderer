    ...
    return (
        <div className='relative portrait:h-[30vh] landscape:h-[90vh] overflow-hidden flex items-end'
            ...
            <Link to={`/destination/${id}`}>
                <button className='absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark bg-opacity-20 border-2 md:border-4 border-offwhite flex items-center px-3 md:py-2 md:px-6'>
                    <span className='font-anton uppercase text-offwhite mix-blend-exclusion tracking-wider text-[7vw] md:text-[5vw]'>{name}</span>
