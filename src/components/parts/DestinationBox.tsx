    ...
    return (
        <div className='relative min-h-[100px] portrait:h-[28vh] landscape:h-[90vh] overflow-hidden flex items-end'
            ...
            <Link to={`/destination/${id}`}>
                <button className={`absolute z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark backdrop-blur-sm bg-opacity-20 border-2 md:border-3 border-white dark:border-2 flex items-center justify-center gap-2 md:py-2 md:px-6 group cursor-point ${longText ? 'portrait:min-w-[58vw] lg:portrait:min-w-[18vw] px-0' : 'w-auto px-4'}`}>
